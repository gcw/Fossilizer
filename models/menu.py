...
response.title = 'Fossilizer'
response.subtitle = T('Fossils for everyone')
...
response.menu  += [
    (T('Fossils'), False, URL(request.application, 'default', 'fossils'),)
        ]

if auth.user_id:
    response.menu  += [
        (T('Create'), False, URL(request.application, 'default', 'create'),
            [
                (T('Clone'), False, URL(request.application, 'default',
                                                    'create/clone')),
                (T('Upload'), False, URL(request.application, 'default',
                                                    'create/upload')),
                (T('From Scratch'), False, URL(request.application, 'default',
                                                    'create/scratch')),
        ])
        ]
